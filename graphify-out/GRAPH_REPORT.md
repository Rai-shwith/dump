...
## Communities (250 total, 188 thin omitted)
...
## Knowledge Gaps
- **555 isolated node(s):** `High-Level Codebase Health Score`, `Critical Architectural Risks`, `Immediate Priorities`, `1. `apps/dump-web/src/components/ui/sidebar.tsx` (744 lines)`, `2. `workers/dump-worker/src/handlers/clipboard.ts` (403 lines)` (+550 more)
...
- **Why does `cn()` connect `Apps Dump` to `Apps Dump`, `Apps Dump`, `Apps Dump`, `Apps Dump`, `Apps Dump`, `Menubar Apps`, `Apps Dump`, `Apps Dump`, `Table Apps`, `Breadcrumb Apps`, `Drawer Apps`, `Apps Dump`, `Apps Dump`, `Card Apps`, `Toggle Apps`, `Alert Apps`, `Avatar Apps`, `Badge Apps`, `Apps Dump`, `radio-group.tsx`?**
  _High betweenness centrality (0.118) - this node is a cross-community bridge._
- **Why does `react` connect `Apps Dump` to `Apps Dump`, `React Apps`?**
  _High betweenness centrality (0.116) - this node is a cross-community bridge._
- **What connects `High-Level Codebase Health Score`, `Critical Architectural Risks`, `Immediate Priorities` to the rest of the system?**
